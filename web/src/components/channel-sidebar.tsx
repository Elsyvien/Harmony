  ...
  return (
    <aside className="channel-sidebar">
      ...
      <section className="sidebar-menu">
        ...
        {props.isAdmin ? (
          <button
            className={props.activeView === 'admin' ? 'channel-item active' : 'channel-item'}
      ...
      <footer>
        <div className="user-panel">
          ...
          <div className="user-controls">
            ...
            >
              <svg width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M10 17v-2h4V9h-4V7h6v10h-6Zm-4 4c-1.1 0-2-.9-2-2V5c0-1.1.9-2 2-2h8v2H6v14h8v2H6Zm12.59-5L22 12.59 18.59 9 17.17 10.41 18.34 11.59H11v2h7.34l-1.17 1.17L18.59 16Z"></path></svg>
            </button>
          </div>
        </div>
      </footer>
